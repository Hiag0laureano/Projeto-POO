...
public class TransacoesPoupanca implements OperacoesPoupanca {
	...
	public String depositar(double valor) {
		...
		return "Deposito realizado. Seu saldo atual é de: "+lstPoupanca.get(0).saldo;
	}
	...
	public String sacar(double valor) {
		...
		if(lstPoupanca.get(0).saldo < valor){
			msg = "Saldo insuficente";
		}
		else {
			lstPoupanca.get(0).saldo -= valor;
			msg = "Saque realizado. Seu saldo atual é de: "+lstPoupanca.get(0).saldo;
		}
		return msg;
	}
	...
	public String saldo() {
		...
		return "Seu saldo atual é de: "+lstPoupanca.get(0).saldo;
	}
...
String msg = "";
		...
		if(lstPoupanca.get(0).saldo < valor){
			...
			lstPoupanca.get(0).saldo -= valor;
			msg = "Transferencia realizada. Seu saldo atual é de: "+lstPoupanca.get(0).saldo;
		}
		return msg;
	}
	...
	public String calcularRendimento(double percentual) {
		...
		return "O seu rendimento foi de: "+rs+" e seu saldo é de: "+ lstPoupanca.get(0).saldo;
	}
